...
namespace Consumer
{
    class Program
    {
        ...
        private const string TOPIC_NAME = "learning.partitions.random";
        static void Main(string[] args)
        {
            ...
            // Note: The producer must be started first because it will create the topic 
            //       and partitions correctly.
